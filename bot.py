...
async def handle(update: Update, context):
    ...
    if ticket_mode.get(uid):
        ...
        await update.message.reply_text("
            ...
            "2️⃣ لطفاً از ارسال پیام‌های تکراری یا اسپم خودداری کنید تا روند رسیدگی سریع‌تر انجام شود./n"
            
            "3️⃣ زمان پاسخ‌دهی ممکن است بسته به حجم درخواست‌ها متفاوت باشد./n"
